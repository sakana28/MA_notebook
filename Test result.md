...
When peripherals configured in the ZC706 board file but not used in this system are disabled in the PS configuration, the power consumption of the PS is slightly reduced as in figure 5.8b. 