...
在ZYNQ芯片内部用硬件实现了AXI总线协议，包括9个物理接口，the PS IP provides multiple AXI ports to enable high-bandwidth communication between the PS and PL over the interconnect.
